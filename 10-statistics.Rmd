...
With the increasing application of machine learning in metabolomics, proper training and reporting are critical. Practical guidance for training machine learning models suggests rigorous validation strategies to avoid overfitting and ensure reproducibility[@zhao2025a]. Furthermore, the EMBRACE checklist provides a framework for environmental machine learning, emphasizing baseline reporting and comprehensive evaluation[@zhu2024].
